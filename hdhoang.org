...
** IRC bot
   ...
   #+BEGIN_SRC python :tangle ~/Public/luser.py
     try:
         from urllib.request import urlopen, build_opener, HTTPCookieProcessor as Cookie
         from urllib.parse import quote
     except ImportError:
         from urllib2 import urlopen, quote, build_opener, HTTPCookieHandler as Cookie
