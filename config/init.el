...
(use-package magit-delta
  :config
  (transient-append-suffix 'magit-dispatch "!" '("#" "My Magit Cmds" th/magit-aux-commands))
  ...
  (:map magit-status-mode-map ((kbd "#") . #'th/magit-aux-commands)
...
;; end https://tsdh.org/posts/2022-08-01-difftastic-diffing-with-magit.html
