...
def _(
    ...
    left_by_meter = 10 * PRICE_00_TO_10 + max(0, left_consumed - 10.0) * PRICE_10_TO_20 + 0 * PRICE_20_TO_30
...
def _(
    ...
    back_by_meter = (
        min(10, back_consumed) * PRICE_00_TO_10 + max(0, back_consumed - 10.0) * PRICE_10_TO_20
    ) + 0 * PRICE_20_TO_30
